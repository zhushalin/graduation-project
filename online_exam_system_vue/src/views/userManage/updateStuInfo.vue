...
export default {
  ...
  methods: {
    handleChange(value) {
      if (value != null) {
        this.passForm.colId = value[0];
        this.passForm.majorId = value[1];
      }
      console.log(value);
    },
    //查询、添加
