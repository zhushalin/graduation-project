    ...
    >
      <template slot="content">
        ...
        >
          ...
          <el-form-item prop="adviceText" label="简介内容">
...
export default {
  ...
  methods: {
      ...
      this.$refs.addForm.validate(async (valid) => {
        if (valid) {
          ...
          if (this.addModel.editType === "0") {
            this.$axios.post("/description/add", this.addModel).then((res) => {
              this.getTeacher();
              this.$message({
                showClose: true,
                message: "恭喜你，操作成功",
            ...
            this.$axios
              .post("/description/update", this.addModel)
              .then((res) => {
                this.getTeacher();
                this.$message({
                  showClose: true,
    ...
    delHandle(id) {
      ...
      this.$axios.post("/description/delete", ids).then((res) => {
        this.$message({
          showClose: true,
          message: "恭喜你，删除成功",
          type: "success",
